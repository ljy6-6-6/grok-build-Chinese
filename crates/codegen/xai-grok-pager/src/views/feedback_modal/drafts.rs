...
impl FeedbackModalState {
    ...
    pub fn mark_draft_submit_pending(&mut self) {
        ...
        self.error = Some(super::localization::text(&self.locale, "Sending draft…").to_owned());
    }
    ...
    pub fn mark_draft_cleanup_failed(&mut self) {
        ...
        self.step = FeedbackModalStep::Write;
        self.error = Some(
            super::localization::text(&self.locale, "Feedback was sent, but the stored draft could not be deleted. Delete it manually; do not resend.")
                .to_owned(),
        );
    }
    ...
    pub fn mark_draft_submit_unknown(&mut self) -> Option<String> {
        ...
        if let Some((draft_id, r#type)) = self.metadata.draft_id.clone().zip(self.metadata.r#type) {
            ...
            self.error = Some(
                super::localization::text(&self.locale, "The remote outcome is unknown. The latest text was copied to the clipboard. Saving it back to this draft; close and do not resend.")
                    .to_owned(),
            );
        ...
        self.error = Some(
            super::localization::text(&self.locale, "The remote outcome is unknown. The latest text was copied to the clipboard. Close and do not resend.")
                .to_owned(),
        );
    ...
    pub fn apply_draft_update_complete(
        ...
        self.error = Some(match error {
            None => {
                super::localization::text(&self.locale, "The remote outcome is unknown. The latest text was saved to this draft and copied to the clipboard. Close and do not resend.")
                    .to_owned()
            }
            Some(_) => {
                super::localization::text(&self.locale, "The remote outcome is unknown. The latest text was copied to the clipboard, but it could not be saved to the draft. Close and do not resend.")
                    .to_owned()
            }
        });
    }
        ...
        rows.iter()
            .filter(|draft| {
                ...
                if let Some(value) = draft.r#type {
                    ...
                    hay.push_str(super::localization::text(&self.locale, value.label()));
                }
