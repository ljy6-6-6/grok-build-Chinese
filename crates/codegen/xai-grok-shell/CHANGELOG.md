...
- **Linux automatic updates** now ship a binary with debug information removed, fixing post-download failures caused by exceeding the updater's extraction safety limits.
